...
export const visionProposals: VisionProposal[] = [
  {
    ...
    evidenceItems: [
      ...
      // ---------------------------------------------------------------
      // --- 高齢者統計（ハートフルプラン21 第2章）---------------------------
      // PDFのテキスト層から数字が取得できなかったため、Chrome（PDFium）で該当ページを
      // 描画し、紙面の表を直接読み取って確認しました。表の内訳と合計・比率の整合も確認済みです。
      // 令和6年度以降の欄は「推計値」のため採用せず、「実績値」のみを掲載しています。
      {
        label: "総人口",
        value: "116,153人",
        year: "令和5（2023）年10月1日現在",
        source: "延岡市「ハートフルプラン21（第9期延岡市高齢者保健福祉計画・介護保険事業計画）」p.6 人口の推移（実績値）",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "出典は住民基本台帳。昭和55年をピークに減少が続いています",
      },
      {
        label: "65歳以上人口（高齢者人口）",
        value: "40,774人",
        ...
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "前期高齢者18,678人・後期高齢者22,096人の合計",
      },
      {
        label: "高齢化率",
        value: "35.1%",
        ...
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "市の高齢者人口は令和3年をピークに減少に転じていますが、高齢化率は上昇が続く見込みとされています",
      },
      {
        label: "75歳以上人口（後期高齢者）",
        value: "22,096人",
        ...
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "令和7年に団塊の世代が75歳以上となることから、今後も増加が見込まれています",
      },
      {
        label: "要支援・要介護認定者数",
        value: "7,011人",
        year: "令和5（2023）年度",
        source: "延岡市「ハートフルプラン21（第9期延岡市高齢者保健福祉計画・介護保険事業計画）」p.8 要介護度別認定者実数（実績値）",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "内訳は要支援1が503人、要支援2が690人、要介護1が1,855人、要介護2が1,323人、要介護3が929人、要介護4が1,056人、要介護5が655人。第2号被保険者（40〜64歳）を含みます",
      },
      {
        label: "要支援・要介護認定率",
        value: "16.9%",
        ...
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "出典は介護保険事業状況報告（各年度9月分）・地域包括ケア見える化システム",
      },
      {
        label: "高齢者の一人暮らし世帯",
        value: "14,560世帯",
        year: "令和5（2023）年",
        source: "延岡市「ハートフルプラン21（第9期延岡市高齢者保健福祉計画・介護保険事業計画）」p.9 高齢者世帯の推移",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "出典は高齢者実態調査。平成元年の11,548世帯から増加が続いています",
      },
      {
        label: "高齢者世帯（65歳以上のみの世帯）",
        value: "23,330世帯",
        year: "令和5（2023）年",
        source: "延岡市「ハートフルプラン21（第9期延岡市高齢者保健福祉計画・介護保険事業計画）」p.9 高齢者世帯の推移",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/28/1150.html",
        confirmedDate: "2026-09-07",
        note: "総世帯数59,759世帯の39.0%。うち二人以上の高齢者世帯は8,770世帯",
      },
      {
        label: "介護保険 第1号被保険者数（65歳以上）",
        value: "40,943人",
        year: "令和4（2022）年度末",
        source: "延岡市「令和5年版 延岡市統計書」11-14 介護保険の状況（資料：介護保険課）",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/1/33640.html",
        confirmedDate: "2026-09-07",
        note: "内訳は65歳以上75歳未満が19,084人、75歳以上が21,859人。住民基本台帳登録者をベースに算出されています",
      },
      {
        label: "介護サービス受給者数",
        value: "7,001人",
        ...
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/1/33640.html",
        confirmedDate: "2026-09-07",
        note: "内訳は在宅サービス4,753人、地域密着型サービス1,204人、施設サービス1,044人。第2号被保険者を含みます",
      },
      {
        label: "介護保険特別会計の歳出決算額",
        value: "140億1,971万円",
        year: "令和6（2024）年度決算",
        source: "延岡市「延岡市の財政事情（令和6年度決算及び令和7年度前期）」令和6年度 歳入歳出決算状況",
        sourceUrl: "https://www.city.nobeoka.miyazaki.jp/soshiki/18/45428.html",
        confirmedDate: "2026-09-07",
        note: "歳入決算額は142億9,791万円。この決算額には介護給付費以外の経費も含みます。介護給付費そのものについては、ハートフルプラン21に「近年の介護給付費は約130億円」と記載されていますが、対象年度が示されていないため単独の指標としては掲載していません",
      },
      // --- ここから既存の指標（変更していません）---------------------------
      {
